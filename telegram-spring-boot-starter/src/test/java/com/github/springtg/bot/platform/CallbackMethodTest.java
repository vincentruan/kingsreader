...
import com.github.springtg.bot.platform.handler.regexp.RegexpMessageHandler;
...
import static com.github.springtg.bot.platform.client.impl.TelegramBotApiImpl.CommandExecutionWrapper.from;
...
public class CallbackMethodTest extends AbstractJUnit4SpringContextTests {
    ...
    public void sendTextCallbackExecuted() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        sendMessage.setText(RegexpMessageHandler.MESSAGE_ANSWER);
