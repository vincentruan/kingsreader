...
import com.github.springtg.bot.platform.CommonTestConfiguration;
import com.github.springtg.bot.platform.client.TelegramBotApi;
import com.github.springtg.bot.platform.common.BaseTestMatcher;
import com.github.springtg.bot.platform.config.BotPlatformConfiguration;
import com.github.springtg.bot.platform.model.UpdateEvent;
import com.github.springtg.bot.platform.model.UpdateEvents;
import com.github.springtg.bot.platform.repository.UpdatesRepository;
import com.github.springtg.bot.platform.worker.UpdatesWorker;
...
import static com.github.springtg.bot.platform.CommonTestConfiguration.CHAT_ID;
...
public class MessageTextMessageHandlerTest extends AbstractJUnit4SpringContextTests {
    ...
    public void sendText() throws InterruptedException {
        ...
        when(message.getText()).thenReturn(MessageTextHandler.MESSAGE_TEXT);
        ...
        callbackMessage.setText(MessageTextHandler.MESSAGE_ANSWER);
    ...
    public void sendTextNoAnswer() throws InterruptedException {
        Update update = Mockito.mock(Update.class);
        Message message = Mockito.mock(Message.class);
        when(message.getText()).thenReturn(MessageTextHandler.MESSAGE_TEXT + "11");
        when(message.getChatId()).thenReturn(CHAT_ID);
        when(update.getMessage()).thenReturn(message);
